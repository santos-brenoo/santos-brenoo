...
<p align="center">I solve great challenges using tech. <br><br>I am <strong>passionate to discover new stuffs</strong> and use them to create high quality solutions. Today, I'm a <strong>analytics engineer</strong> with a strong background in ETL development, data pipeline automation, dashboard creation, and data analysis.</p>&nbsp;
